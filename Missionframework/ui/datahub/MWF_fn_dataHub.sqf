...
switch (_modeUpper) do {
    ...
    case "SET_MODE": {
        ...
        if (_newMode isEqualTo "VEHICLE_MENU") exitWith {
            if (isNil "MWF_fnc_dataHubSetMode") exitWith { false };
    ...
    case "ACTION": {
        ...
        if (_modeNow isEqualTo "VEHICLE_MENU") exitWith {
            if (isNil "MWF_fnc_dataHubPrimaryAction") exitWith { false };
    ...
    case "ACTION_SECONDARY": {
        ...
        if (_modeNow isEqualTo "VEHICLE_MENU") exitWith {
            if (isNil "MWF_fnc_dataHubSecondaryAction") exitWith { false };

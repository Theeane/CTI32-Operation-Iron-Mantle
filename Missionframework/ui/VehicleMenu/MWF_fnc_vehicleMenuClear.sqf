...
private _buttonDefs = [
    ...
    [12211, "Base Building", "private _terminal = uiNamespace getVariable ['MWF_DataHub_ContextTerminal', missionNamespace getVariable ['MWF_CommandTerminal_Object', objNull]]; [_terminal] spawn MWF_fnc_buildMenuMode;", "Open Zeus base building."],

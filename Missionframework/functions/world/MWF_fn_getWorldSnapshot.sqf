...
private _snapshot = createHashMapFromArray [
    ...
    ["worldTierScore", missionNamespace getVariable ["MWF_WorldTierScore", 0]],
    ["worldTierProgress", missionNamespace getVariable ["MWF_WorldTierProgress", 0]],
    ["worldTierFloor", missionNamespace getVariable ["MWF_WorldTierFloor", 1]],
    ["worldTierHalfMapLock", missionNamespace getVariable ["MWF_WorldTierHalfMapLock", false]],
    ["worldTierProgressBlockedUntil", missionNamespace getVariable ["MWF_WorldTierProgressBlockedUntil", 0]],

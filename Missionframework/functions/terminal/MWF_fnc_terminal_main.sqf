...
switch (toUpper _mode) do {
    case "INIT_SCROLL": {
        ...
        _terminal addAction ["<t color='#7CC8FF'>[Terminal] Main Operations</t>", { ["OPEN", _target] call MWF_fnc_terminal_mainOperations; }, nil, 1.25, true, true, "", _cond];
    ...
    case "INIT_ACE": {
        ...
        private _ops = ["MWF_Term_Ops", "Main Operations", "", { ["OPEN", _target] call MWF_fnc_terminal_mainOperations; }, {alive _target}] call ace_interact_menu_fnc_createAction;

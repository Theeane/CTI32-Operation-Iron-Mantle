...
switch (toUpper _mode) do {
    case "INIT_SCROLL": {
        ...
        _terminal addAction ["<t color='#9FD7FF'>[Terminal] Base Building</t>", { [_target] call MWF_fnc_openBuildMenu; }, nil, 1.1, true, true, "", _cond];
    };
    ...
    case "INIT_ACE": {
        ...
        private _build = ["MWF_Term_Build", "Base Building", "", { [_target] call MWF_fnc_openBuildMenu; }, {alive _target}] call ace_interact_menu_fnc_createAction;
        [_terminal, 0, ["ACE_MainActions", "MWF_Term_Root"], _build] call ace_interact_menu_fnc_addActionToObject;
    };

...
diag_log format [
    "[MWF] Campaign state restored. Phase: %1 | Pending saved zones: %2 | Pending vehicles: %3 | Pending built upgrades: %4 | Pending missions: %5 | Pending leader: %6 | Pending attack: %7 | Pending damaged FOBs: %8.",

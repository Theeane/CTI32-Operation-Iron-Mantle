...
MWF_FOB_Truck      = "CUP_B_MTVR_Repair_USMC_WDL";  // Heavy FOB builder truck from CUP USA
...
MWF_Respawn_Truck  = "CUP_B_MTVR_Reammo_USMC_WDL";  // Mobile Respawn vehicle (Ammo truck from CUP USA)
MWF_Crewman        = "CUP_B_USMC_Crew_WDL";         // CUP-specific crewman for vehicles (Woodland)
MWF_Pilot          = "CUP_B_USMC_Pilot_WDL";        // CUP-specific pilot for helicopters (Woodland)
...
MWF_Support_Group1 = [
    ...
    ["CUP_B_USMC_Soldier_SL_WDL", "CUP_B_USMC_Soldier_AR_WDL", "CUP_B_USMC_Soldier_AR_WDL"], 
    150, 2
];

MWF_Support_Group2 = [
    "CUP_Truck_01_transport_F",  // Transport truck from CUP
    ["CUP_B_USMC_Soldier_SL_WDL", "CUP_B_USMC_Soldier_AR_WDL", "CUP_B_USMC_Soldier_AR_WDL", "CUP_B_USMC_Soldier_LAT_WDL", "CUP_B_USMC_Soldier_Medic_WDL"], 
    250, 3
];

MWF_Support_Group3 = [
    "CUP_LSV_01_AT_F",  // Anti-tank light support vehicle from CUP
    ["CUP_B_USMC_Soldier_SL_WDL", "CUP_B_USMC_Soldier_AT_WDL", "CUP_B_USMC_Soldier_AT_WDL", "CUP_B_USMC_Soldier_Medic_WDL"], 
    300, 4
];

MWF_Support_Group4 = [
    "CUP_APC_Wheeled_01_cannon_F",  // Wheeled APC from CUP
    ["CUP_B_USMC_Soldier_SL_WDL", "CUP_B_USMC_Soldier_F_WDL", "CUP_B_USMC_Soldier_M_WDL", "CUP_B_USMC_Soldier_Engineer_WDL"], 
    450, 5
];

MWF_Support_Group5 = [
    "CUP_Heli_Transport_01_F",  // Transport helicopter from CUP
    ["CUP_B_USMC_Soldier_TL_WDL", "CUP_B_USMC_Soldier_F_WDL", "CUP_B_USMC_Soldier_LAT_WDL", "CUP_B_USMC_Soldier_M_WDL"], 
    600, 5
];
...
diag_log "[MWF] Preset: CUP_USA_Woodland.sqf Loaded.";

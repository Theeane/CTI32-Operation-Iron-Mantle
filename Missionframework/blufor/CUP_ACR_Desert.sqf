...
MWF_FOB_Truck      = "CUP_B_TRK_Repair_F";  // CUP-specific truck for repairing
...
MWF_Respawn_Truck  = "B_Truck_01_ammo_F";  // Mobile ammo supply for respawn
MWF_Crewman        = "CUP_B_CZ_Soldier_Desert_F";   // CUP-specific crewman for vehicles
MWF_Pilot          = "CUP_B_CZ_Pilot_Desert_F";  // CUP-specific pilot for helicopters
...
diag_log "[MWF] Preset: CUP_ACR_Desert.sqf Loaded.";

/*
    ...
    Description: 
    Initializes global variables based on Mission Parameters and loads faction presets.
    Language: English
*/

if (!isServer) exitWith {};

// --- 1. SET STARTING RESOURCES ---
// Matches GVAR_Economy_Supplies used in fn_economy.sqf and the UI
...
private _bluFile = switch ("AGS_Param_Blufor" call BIS_fnc_getParamValue) do {
    ...
    case 2:  {"CUP_ACR_Desert.sqf"};
    case 3:  {"CUP_ACR_Woodland.sqf"}; 
    case 4:  {"CUP_BAF_Desert.sqf"}; 
    case 5:  {"CUP_BAF_Woodland.sqf"};
    case 6:  {"CUP_USA_Desert.sqf"}; 
    case 7:  {"CUP_USA_Woodland.sqf"}; 
    case 8:  {"CUP_USMC_Desert.sqf"};
    case 9:  {"GM_West_Germany.sqf"}; 
    case 10: {"LDF_Contact.sqf"}; 
    case 11: {"RHS_USAF_Desert.sqf"};
    case 99: {"Custom_NATO.sqf"}; 
    default  {"NATO.sqf"};
};
...
// --- 7. SYSTEM PARAMETERS ---
// Sync Supply Timer interval (minutes)
...
// Sync Notoriety/Heat multiplier
private _heatMult = "AGS_Param_NotorietyMultiplier" call BIS_fnc_getParamValue;
missionNamespace setVariable ["GVAR_Economy_HeatMult", _heatMult, true];

diag_log "[AGS] Global Initialization and Faction Presets Loaded.";

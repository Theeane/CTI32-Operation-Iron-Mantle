MWF CUSTOM PRESET INSTRUCTIONS - RESISTANCE

Purpose
-------
This folder contains custom preset slots for RESISTANCE.
Custom presets are selected from the Arma multiplayer lobby through the "Resistance Custom Preset" parameter.
...
-----------------------
- In the lobby, set "Resistance Preset Source" to "Custom".
- Then choose a slot in "Resistance Custom Preset".
...
- preset\resistance\AAF.sqf
- preset\resistance\custom\custom_1.sqf

/*
    ...
    Function: Preset - CUP_BAF_Woodland
    Project: Military War Framework

    Description:
    Defines the BLUFOR preset configuration for CUP BAF Woodland.
*/
...
MWF_FOB_Truck      = "CUP_B_MTVR_Repair_BAF_WOOD";  // Heavy FOB builder truck from CUP BAF
MWF_FOB_Box        = "B_Slingload_01_Cargo_F"; // FOB construction container from CUP
MWF_Arsenal_Box    = "B_supplyCrate_F";  // Arsenal crate for supplying gear
MWF_Respawn_Truck  = "CUP_B_MTVR_Reammo_BAF_WOOD";  // Mobile Respawn vehicle (Ammo truck from CUP BAF)
MWF_Respawn_Heli   = "CUP_Heli_Light_01_F"; 
MWF_Virtual_Garage = "Land_HelipadSquare_F"; 

MWF_Crewman        = "CUP_B_BAF_Soldier_Crew_MTP";   // CUP-specific crewman for vehicles (Woodland)
MWF_Pilot          = "CUP_B_BAF_Soldier_Pilot_MTP";  // CUP-specific pilot for helicopters (Woodland)
...
MWF_Support_Group1 = [
    ...
    ["CUP_B_BAF_Soldier_SL_MTP", "CUP_B_BAF_Soldier_AR_MTP", "CUP_B_BAF_Soldier_AR_MTP"], 
    150, 2
];
...
MWF_Support_Group2 = [
    ...
    ["CUP_B_BAF_Soldier_SL_MTP", "CUP_B_BAF_Soldier_AR_MTP", "CUP_B_BAF_Soldier_AR_MTP", "CUP_B_BAF_Soldier_LAT_MTP", "CUP_B_BAF_Soldier_Medic_MTP"], 
    250, 3
];
...
MWF_Support_Group3 = [
    ...
    ["CUP_B_BAF_Soldier_SL_MTP", "CUP_B_BAF_Soldier_AT_MTP", "CUP_B_BAF_Soldier_AT_MTP", "CUP_B_BAF_Soldier_Medic_MTP"], 
    300, 4
];
...
MWF_Support_Group4 = [
    ...
    ["CUP_B_BAF_Soldier_SL_MTP", "CUP_B_BAF_Soldier_F_MTP", "CUP_B_BAF_Soldier_M_MTP", "CUP_B_BAF_Soldier_Engineer_MTP"], 
    450, 5
];
...
MWF_Support_Group5 = [
    ...
    ["CUP_B_BAF_Soldier_TL_MTP", "CUP_B_BAF_Soldier_F_MTP", "CUP_B_BAF_Soldier_LAT_MTP", "CUP_B_BAF_Soldier_M_MTP"], 
    600, 5
];
...
diag_log "[MWF] Preset: CUP_BAF_Woodland.sqf Loaded.";

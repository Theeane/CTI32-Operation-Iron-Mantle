...
MWF_FOB_Truck = "CUP_B_MTVR_Repair_BAF_WOOD";                    // Heavy FOB builder truck
...
MWF_Respawn_Truck = "CUP_B_MTVR_Reammo_BAF_WOOD";               // Mobile Respawn vehicle (Fixed 100 S)
MWF_Crewman = "CUP_B_BAF_Soldier_Crew_MTP";                     // Default crew for armored vehicles
MWF_Pilot = "CUP_B_BAF_Soldier_Pilot_MTP";                    // Default pilot for helis and jets

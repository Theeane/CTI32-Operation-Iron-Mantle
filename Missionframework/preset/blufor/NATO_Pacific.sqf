...
MWF_Respawn_Heli   = "B_T_Heli_Light_01_F"; 
...
MWF_Support_Group1 = [
    ...
    [
        ...
        "B_T_Recon_M_F",                // Marksman
        "B_T_Recon_F"                   // Recon Soldier
    ],
    150, 2
];
...
MWF_Support_Group2 = [
    "B_T_Truck_01_transport_F",  // Transport truck from Pacific
    [
        "B_T_Soldier_SL_F", 
        "B_T_Soldier_AR_F", 
        "B_T_Soldier_AR_F", 
...
// Group Type: AT Team
MWF_Support_Group3 = [
    "B_T_LSV_01_AT_F",  // Anti-tank light support vehicle from Pacific
    [
        "B_T_Soldier_SL_F", 
        "B_T_Soldier_AT_F", 
        "B_T_Soldier_AT_F", 
...
MWF_Support_Group4 = [
    "B_T_APC_Wheeled_01_cannon_F",  // APC from Pacific
    [
        "B_T_Soldier_SL_F", 
        "B_T_Soldier_F_F", 
        "B_T_Soldier_M_F", 
        "B_T_Soldier_Engineer_F"
    ],
    450, 5
];
...
MWF_Support_Group5 = [
    "B_T_Heli_Transport_01_F",  // Transport helicopter from Pacific
    [
        "B_T_Soldier_TL_F", 
        "B_T_Soldier_F_F", 
        "B_T_Soldier_LAT_F", 
...
MWF_Preset_Light = [
    ...
    ["B_T_Quadbike_01_F", 5, 1],  // Pacific Quadbike
    ["B_T_LSV_01_unarmed_F", 20, 1],  // Unarmed LSV from Pacific
    ["B_T_LSV_01_armed_F", 45, 2],  // Armed LSV from Pacific
    ["B_T_MRAP_01_F", 60, 2]  // MRAP vehicle from Pacific
];

MWF_Preset_APC = [
    ["B_T_APC_Wheeled_01_cannon_F", 180, 3],  // APC with cannon from Pacific
    ["B_T_APC_Tracked_01_rcws_F", 200, 3],  // Tracked APC from Pacific
    ["B_T_AFV_Wheeled_01_cannon_F", 250, 4]  // Wheeled AFV from Pacific
];

MWF_Preset_Tanks = [
    ["B_T_MBT_01_cannon_F", 450, 5],  // Main battle tank from Pacific
    ["B_T_MBT_01_TUSK_F", 500, 5],  // TUSK variant tank from Pacific
    ["B_T_MBT_01_arty_F", 650, 5]  // Artillery tank from Pacific
];

MWF_Preset_Helis = [
    [MWF_Respawn_Heli, 150, 3],
    ["B_T_Heli_Light_01_F", 150, 3],  // Light helicopter from Pacific
    ["B_T_Heli_Transport_01_F", 250, 4],  // Transport helicopter from Pacific
    ["B_T_Heli_Transport_03_unarmed_F", 280, 5]  // Unarmed transport helicopter from Pacific
];

MWF_Preset_Jets = [
    ["B_T_Plane_CAS_01_dynamicLoadout_F", 550, 4],  // CAS jet from Pacific
    ["B_T_Plane_Fighter_01_F", 700, 5]  // Fighter jet from Pacific
];
...
// --- 6. SPECIAL ASSETS ---
MWF_Rearm_Truck = ["B_T_Truck_01_Repair_F", 300, 5];  // Rearm truck from Pacific
...
diag_log "[MWF] Preset: NATO_Pacific.sqf Loaded.";

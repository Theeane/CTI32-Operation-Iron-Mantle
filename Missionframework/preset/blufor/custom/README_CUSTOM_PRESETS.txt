MWF CUSTOM PRESET INSTRUCTIONS - BLUFOR

Purpose
-------
This folder contains custom preset slots for BLUFOR.
Custom presets are selected from the Arma multiplayer lobby through the "BLUFOR Custom Preset" parameter.
...
-----------------------
- In the lobby, set "BLUFOR Preset Source" to "Custom".
- Then choose a slot in "BLUFOR Custom Preset".
...
- preset\blufor\NATO.sqf
- preset\blufor\custom\custom_1.sqf

/*
    ...
    Description:
    Handles the create infrastructure system.
*/
...
MWF_fnc_createRoadblock = {
    ...
    private _objects = [_pos, _dir, "MWF_Composition_Roadblock"] call MWF_fnc_spawnComposition; 
    ...
    
    {
        ...
        _x setVariable ["MWF_ParentZoneID", _id, true];
        _x setVariable ["MWF_ZoneType", "RB", true];
...
MWF_fnc_createHQ = {
    ...
    private _objects = [_pos, _dir, "MWF_Composition_HQ"] call MWF_fnc_spawnComposition;
    ...
    
    {
        // TAGGING FOR CLEANUP SYSTEM
        _x setVariable ["MWF_ParentZoneID", _id, true];
        _x setVariable ["MWF_ZoneType", "HQ", true];

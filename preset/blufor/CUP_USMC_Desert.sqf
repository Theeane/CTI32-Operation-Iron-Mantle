...
MWF_FOB_Truck      = "CUP_B_MTVR_Repair_USMC_DES";  // Heavy FOB builder truck from CUP USMC
...
MWF_Respawn_Truck  = "CUP_B_MTVR_Reammo_USMC_DES";  // Mobile Respawn vehicle (Ammo truck from CUP USMC)
MWF_Crewman        = "CUP_B_USMC_Crew_DES";         // Default crew from CUP USMC
MWF_Pilot          = "CUP_B_USMC_Pilot_DES";        // Default pilot from CUP USMC
...
MWF_Support_Group1 = [
    "CUP_B_M1114_UA_M2_DES_USMC",  // Armed light support vehicle from CUP
...
diag_log "[MWF] Preset: CUP_USMC_Desert.sqf Loaded.";
